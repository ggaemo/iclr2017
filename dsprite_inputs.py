...
def make_tfrecords_single():
    ...
    filename = 'dsprite/random_data/dsprite.tfrecords'

    if os.path.exists(filename):
        print(filename, 'exists')
    else:
        data = np.load('dsprite/random_data/data.npz')
...
def inputs(batch_size, num_threads):
...
def inputs_single_file(batch_size, num_threads):
    filenames = 'dsprite/random_data/dsprite.tfrecords'
